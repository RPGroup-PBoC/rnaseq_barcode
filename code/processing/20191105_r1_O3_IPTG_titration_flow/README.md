---
status: Rejected
notes: Some data points are way off from the expectation. 
---
# 2019-11-05 Operator O3 IPTG titration
...
| `none` | `galK<>O3+11-gfp-barcode ΔlacIZYA` | `HG105` | `delta`|
| `none` | `galK<>O3+11-gfp-barcode ΔlacZYA` | `HG104` | `R22`|
| `none` | `galK<>O3+11-gfp-barcode; ybcn<>3*1-RBS1147-lacI ΔlacIZYA` | `HG105` | `R60`|
| `none` | `galK<>O3+11-gfp-barcode; ybcn<>3*1-RBS446-lacI ΔlacIZYA` | `HG105` | `R124`|
| `none` | `galK<>O3+11-gfp-barcode; ybcn<>3*1-RBS1027-lacI ΔlacIZYA` | `HG105` | `R260`|
| `none` | `galK<>O3+11-gfp-barcode; ybcn<>3*1-RBS1-lacI ΔlacIZYA` | `HG105` | `R1220`|
| `none` | `galK<>O3+11-gfp-barcode; ybcn<>3*1-RBS1L-lacI ΔlacIZYA` | `HG105` | `R1740`|
...
For this particular strain we lost the data for the first two measurements, i.e.
1. auto - 0 µM IPTG
2. ∆lacI - 0 µM IPTG
Since the measurements for 0.1 µM are ususally pretty similar, in the pipeline we
use such data to replace the missing one.

For reasons we can't explain, the 5000µM measurement for R1740 went completely 
wrong.
