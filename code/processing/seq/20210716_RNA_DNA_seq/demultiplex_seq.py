...
RAW_DIR = INPUT_DIR + '210715_M05340_0267_000000000-JRL6V/Data/Intensities/BaseCalls/'
...
sequence_type = 'EMPSingleEndSequences'  # Single end illumina sesquences
...
if not os.path.exists(artifact_file):
    ...
    # Define bash command to generate artifact for qiime to register sequences
