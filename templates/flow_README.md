...
---
# YYYY-MM-DD Operator Ox IPTG titration
...
| `none` | `galK<>Ox+11-gfp-barcode ΔlacIZYA` | `HG105` | `delta`|
| `none` | `galK<>Ox+11-gfp-barcode ΔlacZYA` | `HG104` | `R22`|
| `none` | `galK<>Ox+11-gfp-barcode; ybcn<>3*1-RBS1147-lacI ΔlacIZYA` | `HG105` | `R60`|
| `none` | `galK<>Ox+11-gfp-barcode; ybcn<>3*1-RBS446-lacI ΔlacIZYA` | `HG105` | `R124`|
| `none` | `galK<>Ox+11-gfp-barcode; ybcn<>3*1-RBS1027-lacI ΔlacIZYA` | `HG105` | `R260`|
| `none` | `galK<>Ox+11-gfp-barcode; ybcn<>3*1-RBS1-lacI ΔlacIZYA` | `HG105` | `R1220`|
| `none` | `galK<>Ox+11-gfp-barcode; ybcn<>3*1-RBS1L-lacI ΔlacIZYA` | `HG105` | `R1740`|
