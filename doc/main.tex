...
% Add library
\addbibresource{./rnaseq_barcode_bib}
...
\title{\textbf{Quantitative Measurements of Gene Regulation using Sequencing}}
% Authors
\author[1, *]{Manuel Razo-Mejia}
\author[1, *]{Tom R\"oschinger}
\author[1, *]{Scott Saunders}
\author[1]{Suzannah M Beeler}
